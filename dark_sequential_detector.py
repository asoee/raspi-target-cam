#!/usr/bin/env python3
"""
Sequential Dark-to-Darker Detector
Combines sequential scanning with dark-to-darker detection approach
"""
...
class DarkSequentialDetector:
    """
    Detects shots sequentially using dark-to-darker changes
    """
    ...
    def __init__(self):
        ...
        self.min_darkness_increase = 15
        self.min_relative_change = 0.20
        self.min_concentration = 0.30
        self.min_area = 50
        self.max_area = 5000
    ...
    def set_reference(self, frame, frame_num=0):
        ...
        print(f"   Dark area threshold: {self.dark_threshold}")
    ...
    def detect_new_shots(self, frame, frame_num):
        ...
        # Find dark-to-darker changes
        candidates = self._find_dark_to_darker_changes(self.reference_gray, current_gray)
    ...
    def _find_dark_to_darker_changes(self, before_gray, after_gray):
        """Find dark-to-darker changes in dark areas"""
...
def test_dark_sequential_detection(video_path, reference_frame=50, scan_frames=None):
    """
    Test dark-to-darker sequential detection on video
    """
    print("🎯 Dark-to-Darker Sequential Shot Detection")
    print("=" * 70)
    ...
    detector = DarkSequentialDetector()
    ...
    for frame_num in scan_frames:
        ...
        if new_shots:
            for shot in new_shots:
                ...
                print(f"       Position: ({shot['x']}, {shot['y']})")
    ...
    with open('dark_sequential_results.json', 'w') as f:
        json.dump(output, f, indent=2)

    print(f"\n💾 Results saved to: dark_sequential_results.json")
...
if __name__ == "__main__":
    ...
    shots = test_dark_sequential_detection(video_path, reference_frame=50, scan_frames=range(51, 1000))

    print(f"\n✅ Dark-to-darker sequential detection complete!")
